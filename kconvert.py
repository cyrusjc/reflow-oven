...
mV_to_C_1 = (+0.0000000E+00, +2.5173462E+01, -1.1662878E+00, -1.0833638E+00,
             ...
             -5.1920577E-04, +0.000000E+00)
#  0 C to 500 C: 0 mV to 20.644 mV
mV_to_C_2 = (-0.000000E+00, +2.5083550E+01, +7.8601060E-02, -2.5031310E-01,
...
'''
mV_to_C_1 = (+0.0000000E+00, +2.5173462E+04, -1.1662878E+03, -1.0833638E+03,
             -8.9773540E+02, -3.7342377E+02, -8.6632643E+01, -1.0450598E+01,
             -5.1920577E-01, +0.0000000E+00)
#  0 C to 500 C: 0 mV to 20.644 mV
mV_to_C_2 = (+0.0000000E+00, +2.5083550E+04, +7.8601060E+01, -2.5031310E+02,
             +8.3152700E+01, -1.2280340E+01, +9.8040360E-01, -4.4130300E-02,
             +1.0577340E-03, -1.0527550E-05)
# 500 C to 1372 C: 20.644 mV to 54.886 mV
mV_to_C_3 = (-1.3180580E+05, +4.8302220E+04, -1.6460310E+03, +5.4647310E+01,
             -9.6507150E-01, +8.8021930E-03, -3.1108100E-05, +0.0000000E+00,
             +0.0000000E+00, +0.0000000E+00)
'''
ranges_mV_to_C = (-5.891, 0.0, 20.644, 54.886)
#ranges_mV_to_C = (-5891, 0.0, 20644, 54886)

def mV_to_C(mVolts, ColdJunctionTemp):
    total_mV=mVolts+0.5+C_to_mV(ColdJunctionTemp)
...
'''
C_to_mV_1 = ( +0.000000000000E+00, +0.394501280250E+02, +0.236223735980E-01, -0.328589067840E-03,
              -0.499048287770E-05, -0.675090591730E-7, -0.574103274280E-09, -0.310888728940E-11,
              -0.104516093650E-13, -0.198892668780E-16, -0.163226974860E-19)
#   0 C to 1372 C
C_to_mV_2 = ( -0.176004136860E+02, +0.389212049750E+02, +0.185587700320E-01, -0.994575928740E-04,
              +0.318409457190E-06, -0.560728448890E-09, +0.560750590590E-12, -0.320207200030E-15,
              +0.971511471520E-19, -0.121047212750E-22)
a = (+0.118597600000E+00, -0.118343200000E-03, +0.126968600000E+03)
ranges_C_to_mV = (-270.0, 0.0, 1372.0)
'''


def C_to_mV(tempC): # find this, where did they do the thing?
